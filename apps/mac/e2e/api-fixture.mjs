...
const server = createServer(async (req, res) => {
  ...
  try {
    ...
    if (req.method === 'GET' && path.startsWith('/quant/')) state.quantReadRequestCount += 1;
