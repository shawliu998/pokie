...
export function SignalDetail({ signal, sources, disabled, onLoadSamples, onTriage, onStart }: { signal: Signal; sources: SourceHealth[]; disabled: boolean; onLoadSamples: () => Promise<SignalSample[]>; onTriage: (impact: Impact, urgency: Urgency) => void; onStart: () => void }) {
