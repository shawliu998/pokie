...
failure. Sanitized evidence is
`.run/v1-kraken-deepseek-20260724-183209/v1-kraken-evidence.json`. This is engineering evidence
...
![Qurio approved executable research plan](./docs/assets/pokiequant/p1c-02-plan-approval-1440x960.png)

![Qurio evidence-driven Candidate C decision ledger](./docs/assets/pokiequant/p1c-04-observation-to-c-1440x960.png)

![Qurio final machine-readable evidence export](./docs/assets/pokiequant/p1c-05-report-json-1440x960.png)

![Qurio historical report reopen](./docs/assets/pokiequant/p1c-06-history-reopen-1440x960.png)
...
![Qurio final live Data, Kraken BTCUSD 4h, 548 closed bars](./docs/assets/pokiequant/v1-final-183209-01-data-1440x960.png)

![Qurio final live Decision Ledger with Candidate C repair](./docs/assets/pokiequant/v1-final-183209-02-ledger-repair-1440x960.png)

![Qurio final live Analysis, train ranking C/B/A, evidence selects B](./docs/assets/pokiequant/v1-final-183209-03-analysis-selection-1440x960.png)

![Qurio final live sealed holdout failure and revise_research](./docs/assets/pokiequant/v1-final-183209-04-holdout-revise-1440x960.png)

![Qurio final live E0 JSON evidence export](./docs/assets/pokiequant/v1-final-183209-05-e0-export-1440x960.png)

![Qurio final live History reopen from retained run](./docs/assets/pokiequant/v1-final-183209-06-history-reopen-1440x960.png)
